...
\newcommand\Bstrut{\rule[-0.9ex]{0pt}{0pt}}   % = `bottom' strut
  ...
  \begin{tabular}{|l|p{115mm}|}\hline
    ...
    \Tstrut\Bstrut Fecha de Entrega Contractual:& Julio - 2018\\\hline
    \Tstrut\Bstrut Fecha de Entrega& Julio - 2018\\\hline
...
Las irregularidades en los padrones de beneficiarios son usualmente difíciles de detectar pues la información en general no se encuentra ordenada de una manera que permita hacer los estudios de una manera concreta y mucho menos teniendo en cuenta la cantidad de información que se debe procesar para generar las estadísticas necesarias.
\clearpage
